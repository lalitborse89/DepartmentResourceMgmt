  ...
  <h3>DateTimePickers selected by class</h3>
    ...
    function getEntry(){
       ...
       // alert(RegExp.source);
        ...
        str="haaaa haa jaaa naaa "
        	 alert("str repeat wala-->"+str.repeat(2));
        
        alert("g wala-->"+str.match(/aa/g));
        alert("g wala address-->"+str.search(/aa/g));
        
        alert("i wala-->"+str.match(/aa/i));
        alert("gi wala-->"+str.match(/aa/gi));
       //  alert(str.replace(regexp, replaceValue));
